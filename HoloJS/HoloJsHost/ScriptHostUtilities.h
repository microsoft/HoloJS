...
class ScriptHostUtilities {
   public:
    ...
    static bool ProjectFunction(const std::wstring& name,
                                const std::wstring& namespaceName,
                                JsNativeFunction function,
                                void* callbackState,
                                JsValueRef* scriptFunction);

    static bool ProjectFunction(const std::wstring& name, const std::wstring& namespaceName, JsNativeFunction function)
    {
