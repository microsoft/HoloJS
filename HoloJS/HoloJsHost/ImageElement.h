...
class ImageElement : public HologramJS::Utilities::ElementWithEvents, public HologramJS::Utilities::IRelease {
   ...
   private:
    ...
    static JsValueRef CHAKRA_CALLBACK createImage(_In_ JsValueRef callee,
    ...
    static JsValueRef CHAKRA_CALLBACK setImageSource(_In_ JsValueRef callee,
                                                     _In_ bool isConstructCall,
                                                     _In_ JsValueRef* arguments,
                                                     _In_ unsigned short argumentCount,
                                                     _In_ PVOID callbackData);
    ...
    static JsValueRef CHAKRA_CALLBACK setImageSourceFromBlob(_In_ JsValueRef callee,
                                                             _In_ bool isConstructCall,
                                                             _In_ JsValueRef* arguments,
                                                             _In_ unsigned short argumentCount,
                                                             _In_ PVOID callbackData);
    ...
    static JsValueRef CHAKRA_CALLBACK getImageData(_In_ JsValueRef callee,
                                                   _In_ bool isConstructCall,
                                                   _In_ JsValueRef* arguments,
                                                   _In_ unsigned short argumentCount,
                                                   _In_ PVOID callbackData);
